...
<div class="row">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                <td align="center"><input type="checkbox" name="operate" value="<?php echo ($vo["role_id"]); ?>"></td>
                                <td align="center"><?php echo ($vo["role_id"]); ?></td>
                                <td align="center"><?php echo ($vo["role_name"]); ?></td>
                                <td align="center ids"><?php echo ($vo["role_auth_ids"]); ?></td>
    ...
    <script>
        ...
        $("#add").on("click", function(){
            window.location = '<?php echo U("Admin/Role/add");?>';
        })
        //编辑
        $('#update').on("click",function(){
            var url = '<?php echo U("Admin/Role/update");?>';
            updateFn(url);
            return false;
        });
        //删除
        $('#del').on("click",function(){
            var url = '<?php echo U("Admin/Role/del");?>';
