...
<!-- /左侧 -->
                        ...
                        <div class="col-lg-12 col-sm-12 col-xs-12">
                            <div class="widget">
                                <div class="widget-header bordered-bottom bordered-blue">
                                    <span class="widget-caption">新增大图</span>
                                </div>
                                    ...
                                    <div id="horizontal-form">
                                        <form class="form-horizontal" id="uploadFiyForm" role="form">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input class="form-control" id="name" placeholder="请输入标题" name="name" required="required" type="text">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input class="form-control" id="describe" placeholder="请输入描述" name="describe" required="required" type="text">
                                                </div>
                                                <p class="help-block col-sm-4 red">* 必填</p>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <img src="/team/Uploads/defualt/5a26abb387ea9.jpg" id="jcopPic" class="img-responsive" alt="">
                                                </div>
                                            </div>
                                            <div class="form-group">
    ...
    <script>
        ...
        $("#uploadFiyForm").submit(function(){
            var url = '/team/index.php/Admin/Big/add.html';
