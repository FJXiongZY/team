...
<!-- /左侧 -->
                                    ...
                                    <div id="horizontal-form">
                                        <form class="form-horizontal" id="addForm" role="form">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input class="form-control" id="group_title" placeholder="请输入团队简介名" name="group_title" required="required" type="text">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <select name="group_parent" id="group_parent" style="width: 100%;">
                                                        ...
                                                        <?php if(is_array($groupParent)): $i = 0; $__LIST__ = $groupParent;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$gPid): $mod = ($i % 2 );++$i;?><option value="<?php echo ($gPid["auth_id"]); ?>"><?php echo ($gPid["auth_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group">
    ...
    <script>
        ...
        $("#addForm").submit(function(){
            var url = '/team/index.php/Admin/Group/add.html';
