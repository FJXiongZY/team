...
<!-- /左侧 -->
                        ...
                        <div class="col-lg-12 col-sm-12 col-xs-12">
                            <div class="widget">
                                <div class="widget-header bordered-bottom bordered-blue">
                                    <span class="widget-caption">新增团队信息</span>
                                </div>
                                    ...
                                    <div id="horizontal-form">
                                        <form class="form-horizontal" id="addForm" role="form">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input class="form-control" id="Talent_title" placeholder="请输入标题" name="Talent_title" required="required" type="text">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <select name="Talent_parent" id="Talent_parent" style="width: 100%;">
                                                        ...
                                                        <?php if(is_array($TalentParent)): $i = 0; $__LIST__ = $TalentParent;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tPid): $mod = ($i % 2 );++$i;?><option value="<?php echo ($tPid["auth_id"]); ?>"><?php echo ($tPid["auth_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group">
    ...
    <script>
        ...
        $("#addForm").submit(function(){
            var url = '/team/index.php/Admin/Talent/add.html';
