...
<!-- /左侧 -->
                                    ...
                                    <div id="horizontal-form">
                                        <form class="form-horizontal" id="updateForm" role="form">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input class="form-control" id="Notice_title" placeholder="请输入名称" name="Notice_title" value="<?php echo ($cur["title"]); ?>" required="required" type="text">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <select name="Notice_parent" id="Notice_parent" style="width: 100%;">
                                                        <?php if(is_array($NoticeParent)): $i = 0; $__LIST__ = $NoticeParent;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$Pid): $mod = ($i % 2 );++$i;?><option <?php if($cur['parent'] == $Pid['auth_id']): ?>selected="selected"<?php endif; ?> value="<?php echo ($Pid["auth_id"]); ?>"><?php echo ($Pid["auth_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group">
    ...
    <script>
        ...
        $("#updateForm").submit(function(){
            var url = '/team/index.php/Admin/Notification/update.html?id=16';
