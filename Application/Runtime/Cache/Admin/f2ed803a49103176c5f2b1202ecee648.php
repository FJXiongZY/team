...
<!-- /左侧 -->
            ...
            <div class="page-content">
                ...
                <div class="page-body">
                    <div class="userCount">
                        <label for="">当前在线用户人数: <b><?php echo ($inline); ?></b></label>
                    </div>
                    <div>
                        <label>当前在线用户：</label>
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                <?php if(is_array($array)): $i = 0; $__LIST__ = $array;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td><?php echo ($vo["admin_ip"]); ?></td>
                                    <td><?php echo (getipcity($vo["admin_ip"])); ?></td>
                                    <td><?php echo (date('Y-m-d H:m:s',$vo["admin_logTime"])); ?></td>
