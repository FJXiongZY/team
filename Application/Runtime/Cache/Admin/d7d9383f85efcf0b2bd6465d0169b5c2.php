...
<!-- /左侧 -->
                                    ...
                                    <div id="horizontal-form">
                                        <form class="form-horizontal" id="updateForm" role="form">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input class="form-control" id="admin_name" placeholder="请输入用户名" name="admin_name" value="<?php echo ($cur["name"]); ?>" required="required" type="text">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input class="form-control" id="admin_password" value="<?php echo ($cur["password"]); ?>" placeholder="请输入密码" name="admin_password" required="required" type="text">
                                                </div>
                                                <p class="help-block col-sm-4 red">* 必填</p>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <?php if(is_array($roleInfo)): $i = 0; $__LIST__ = $roleInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$roleInfo): $mod = ($i % 2 );++$i;?><option <?php if($cur['role_id'] == $roleInfo['role_id']): ?>selected="selected"<?php endif; ?> value="<?php echo ($roleInfo["role_id"]); ?>"><?php echo ($roleInfo["role_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
    ...
    <script>
        $("#updateForm").submit(function(){
            var url = '/team/index.php/Admin/Administrator/update.html?id=88';
