...
<!-- /左侧 -->
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="/team/index.php/Admin/Bot/showList">团队建设方案管理</a>
                        </li>
                                    ...
                                    <div id="horizontal-form">
                                        <form class="form-horizontal" id="updateForm" role="form">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input class="form-control" id="Bot_title" placeholder="请输入团队建设方案名" name="Bot_title" value="<?php echo ($cur["title"]); ?>" required="required" type="text">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <select name="Bot_parent" id="Bot_parent" style="width: 100%;">
                                                        <?php if(is_array($BotParent)): $i = 0; $__LIST__ = $BotParent;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$bPid): $mod = ($i % 2 );++$i;?><option <?php if($cur['parent'] == $bPid['auth_id']): ?>selected="selected"<?php endif; ?> value="<?php echo ($bPid["auth_id"]); ?>"><?php echo ($bPid["auth_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group">
    ...
    <script>
        ...
        $("#updateForm").submit(function(){
            var url = '/team/index.php/Admin/Bot/update.html?id=7';
            var data = $(this).serialize();
            var successUrl = '<?php echo U("Admin/Bot/showList");?>';
            if (!$('#Bot_title').val()) {
                dialog.error("标题不能为空");
            }else if (!$('#Bot_parent').val()) {
                dialog.error("请选择父级");
            }else{
