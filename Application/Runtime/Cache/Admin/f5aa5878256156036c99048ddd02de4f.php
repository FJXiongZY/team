...
<!-- /左侧 -->
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="/team/index.php/Admin/Bot/showList">团队建设管理</a>
                        </li>
                                    ...
                                    <div id="horizontal-form">
                                        <form class="form-horizontal" id="addForm" role="form">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input class="form-control" id="Bot_title" placeholder="请输入团队建设名" name="Bot_title" required="required" type="text">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <select name="Bot_parent" id="Bot_parent" style="width: 100%;">
                                                        ...
                                                        <?php if(is_array($BotParent)): $i = 0; $__LIST__ = $BotParent;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$bPid): $mod = ($i % 2 );++$i;?><option value="<?php echo ($bPid["auth_id"]); ?>"><?php echo ($bPid["auth_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group">
    ...
    <script>
        ...
        $("#addForm").submit(function(){
            var url = '/team/index.php/Admin/Bot/add.html';
