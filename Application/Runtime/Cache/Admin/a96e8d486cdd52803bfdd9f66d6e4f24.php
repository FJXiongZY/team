...
<!-- /左侧 -->
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="/team/index.php/Admin/Group/showList">团队简介管理</a>
                        </li>
                                    ...
                                    <div id="horizontal-form">
                                        <form class="form-horizontal" id="updateForm" role="form">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input class="form-control" id="group_title" placeholder="请输入团队简介名" name="group_title" value="<?php echo ($cur["title"]); ?>" required="required" type="text">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <select name="group_parent" id="group_parent" style="width: 100%;">
                                                        <?php if(is_array($groupParent)): $i = 0; $__LIST__ = $groupParent;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$gPid): $mod = ($i % 2 );++$i;?><option <?php if($cur['parent'] == $gPid['auth_id']): ?>selected="selected"<?php endif; ?> value="<?php echo ($gPid["auth_id"]); ?>"><?php echo ($gPid["auth_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group">
    ...
    <script>
        ...
        $("#updateForm").submit(function(){
            var url = '/team/index.php/Admin/Group/update.html?id=14';
            var data = $(this).serialize();
            var successUrl = '<?php echo U("Admin/Group/showList");?>';
            if (!$('#group_title').val()) {
                dialog.error("标题不能为空");
            }else if (!$('#group_parent').val()) {
                dialog.error("请选择父级");
            }else{
