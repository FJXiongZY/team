...
<!-- /左侧 -->
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="/team/index.php/Admin/Talent/showList">人才培养管理</a>
                        </li>
                                    ...
                                    <div id="horizontal-form">
                                        <form class="form-horizontal" id="updateForm" role="form">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input class="form-control" id="Talent_title" placeholder="请输入标题名" name="Talent_title" value="<?php echo ($cur["title"]); ?>" required="required" type="text">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <select name="Talent_parent" id="Talent_parent" style="width: 100%;">
                                                        <?php if(is_array($TalentParent)): $i = 0; $__LIST__ = $TalentParent;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tPid): $mod = ($i % 2 );++$i;?><option <?php if($cur['parent'] == $tPid['auth_id']): ?>selected="selected"<?php endif; ?> value="<?php echo ($tPid["auth_id"]); ?>"><?php echo ($tPid["auth_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <textarea style="height:200px;" id="editor"><?php echo htmlspecialchars_decode($cur['content']);?></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
    ...
    <script>
        ...
        $("#updateForm").submit(function(){
            var url = '/team/index.php/Admin/Talent/update.html?id=8';
            var data = $(this).serialize();
            var successUrl = '<?php echo U("Admin/Talent/showList");?>';
            if (!$('#Talent_title').val()) {
                dialog.error("标题不能为空");
            }else if (!$('#Talent_parent').val()) {
                dialog.error("请选择父级");
            }else{
