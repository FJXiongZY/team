						...
						<div class="top">
							<div class="media">
								<div class="media-left text-center">
									<div class="userImg">
										<img src="/team/Uploads/userPic/<?php echo ($cur["userPic"]); ?>" width="150" alt="我的头像" title="我的头像" />
									</div>
								</div>
								<div class="media-body">
									<div class="userInfo">
										<ol class="list-inline">
											<li class="col-md-6"><span class="glyphicon glyphicon-user"></span>&nbsp;<?php echo ($cur["name"]); ?>&nbsp;您好！</li>
											<li class="col-md-6">邮箱：<?php echo (isuserinfo($cur["email"])); ?></li>
											<li class="col-md-6">性别：<?php echo (getsex($cur["male"])); ?></li>
											<li class="col-md-6">手机：<?php echo (isuserinfo($cur["phone"])); ?></li>
											<li class="col-md-6">等级：<?php echo (getlevel($cur["role_id"])); ?></li>
											<li class="col-md-6">微信号：<?php echo (isuserinfo($cur["weChat"])); ?></li>
						...
						<div class="bottom">
							<div class="logInfo">
								<table class="table table-hover">
									...
									<tbody>
										<?php if(is_array($loginInfo)): $i = 0; $__LIST__ = $loginInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
											<td><?php echo ($i); ?></td>
