            ...
            <div class="page-content">
                ...
                <div class="page-body">
                    ...
                    <div class="page-search">
                        <form class="form-inline" action="/team/index.php/Admin/Group/showList.html" method="post">
                            ...
                            <div class="form-group">
                                <select name="group_parent" class="form-control">
                                    <option value="">---选择全部---</option>
                                    <?php if(is_array($groupParent)): $i = 0; $__LIST__ = $groupParent;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option <?php if($condtion['parent'] == $vo['auth_id']): ?>selected="selected"<?php endif; ?> value="<?php echo ($vo["auth_id"]); ?>"><?php echo ($vo["auth_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </div>
                            <div class="form-group">
                                <input type="text" name="group_title" class="form-control" placeholder="标题名称">
                            </div>
...
<div class="row">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td align="center">
                                    <a href="/team/index.php/Admin/Group/particular/admin_id/<?php echo ($vo["id"]); ?>" class="btn btn-info btn-sm shiny">
    ...
    <script>
        var successUrl = '<?php echo U("Admin/Group/showList");?>';
        //添加
        $("#add").on("click", function(){
            window.location = '<?php echo U("Admin/Group/add");?>';
        })
        //编辑菜单
        $('#update').on("click",function(){
            var url = '<?php echo U("Admin/Group/update");?>';
            updateFn(url);
            return false;
        });
        //删除
        $('#del').on("click",function(){
            var url = '<?php echo U("Admin/Group/del");?>';
            batch('是否删除?', url, successUrl);
            return false;
        });
        //上线
        $("#toLine").on("click", function(){
            var url = '<?php echo U("Admin/Group/toLine");?>';
        ...
        $("#offLine").on("click", function(){
            var url = '<?php echo U("Admin/Group/offLine");?>';
