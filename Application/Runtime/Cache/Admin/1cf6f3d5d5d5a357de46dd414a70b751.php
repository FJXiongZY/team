            ...
            <div class="page-content">
                ...
                <div class="page-body">
                    ...
                    <div class="page-search">
                        <form class="form-inline" action="/team/index.php/Admin/Notification/showList.html" method="post">
                            ...
                            <div class="form-group">
                                <select name="Notice_parent" class="form-control">
                                    ...
                                    <?php if(is_array($NoticeParent)): $i = 0; $__LIST__ = $NoticeParent;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option <?php if($condtion['parent'] == $vo['auth_id']): ?>selected="selected"<?php endif; ?> value="<?php echo ($vo["auth_id"]); ?>"><?php echo ($vo["auth_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </div>
                            <div class="form-group">
...
<div class="row">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td align="center">
                                    <a href="/team/index.php/Admin/Notification/particular/admin_id/<?php echo ($vo["id"]); ?>" class="btn btn-info btn-sm shiny">
    ...
    <script>
        ...
        $("#add").on("click", function(){
            window.location = '<?php echo U("Admin/Notification/add");?>';
        })
        //编辑菜单
        $('#update').on("click",function(){
            var url = '<?php echo U("Admin/Notification/update");?>';
            updateFn(url);
            return false;
        });
        //删除
        $('#del').on("click",function(){
            var url = '<?php echo U("Admin/Notification/del");?>';
            batch('是否删除?', url, successUrl);
            return false;
        });
        //上线
        $("#toLine").on("click", function(){
            var url = '<?php echo U("Admin/Notification/toLine");?>';
        ...
        $("#offLine").on("click", function(){
            var url = '<?php echo U("Admin/Notification/offLine");?>';
