...
class TalentModel extends Model{
    protected $_map = array(
        'Talent_id' => 'id',
        "Talent_title"  => 'title',
        'Talent_createTime' => 'createTime',
        'Talent_count' => 'count',
        'editorValue' => 'content',
        'Talent_status' => 'status',
        'Talent_parent' => 'parent'
    );
    ...
    public function getTalentParent(){
    ...
    public function getPagesInfo($limit){
        $indexpage=I("p",1,"int");
        if(I('Talent_status',1)){
            $condtion['status']=I("Talent_status",1);
        }
        if(I('Talent_parent')){
            $condtion['parent']=I("Talent_parent");
        }
        if(I('Talent_title')){
            $condtion['title']=array("like","%".trim(I('Talent_title'))."%");
        }
        if ($condtion) {
