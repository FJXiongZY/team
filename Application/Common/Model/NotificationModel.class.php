...
class NotificationModel extends Model{
    protected $_map = array(
        'Notice_id' => 'id',
        "Notice_title"  => 'title',
        'Notice_createTime' => 'createTime',
        'Notice_count' => 'count',
        'editorValue' => 'content',
        'Notice_status' => 'status',
        'Notice_parent' => 'parent'
    );
    ...
    public function getNoticeParent(){
    ...
    public function getPagesInfo($limit){
        ...
        if(I('Notice_status',1)){
            $condtion['status']=I("Notice_status",1);
        }
        if(I('Notice_parent')){
            $condtion['parent']=I("Notice_parent");
        }
        if(I('Notice_title')){
            $condtion['title']=array("like","%".trim(I('Notice_title'))."%");
        }
        if ($condtion) {
